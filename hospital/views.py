...
#for showing signup/login button for admin(by Skye)
...
#for showing signup/login button for doctor(by Skye)
...
#for showing signup/login button for patient(by Skye)
...
#-----------for checking user is doctor , patient or admin(by Skye)
def is_admin(user):
